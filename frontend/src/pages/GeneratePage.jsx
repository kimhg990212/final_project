  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      for (let i = 0; i < 30; i++) {
        ...
        if (resultData.result_text && resultData.result_text !== "처리 중...") {
          resultContent = resultData.result_text;
          break;
        }
      }
