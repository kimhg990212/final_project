...
async def detect_plagiarism_endpoint(
    trademark_name: Optional[str] = Form(None, description="Trademark name"),
    description_query: Optional[str] = Form(None, description="Additional description"),
    text_query: Optional[str] = Form(None, description="Legacy text query"),
